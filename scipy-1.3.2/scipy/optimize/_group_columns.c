...
/* "scipy/optimize/_group_columns.pyx":18
...
static PyObject *__pyx_pw_5scipy_8optimize_14_group_columns_1group_dense(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("group_dense (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("group_dense", 1, 3, 3, 1); __PYX_ERR(0, 18, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_A)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("group_dense", 1, 3, 3, 2); __PYX_ERR(0, 18, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "group_dense") < 0)) __PYX_ERR(0, 18, __pyx_L3_error)
      }
    ...
    __pyx_v_m = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_m == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_n = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 18, __pyx_L3_error)
    __pyx_v_A = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_A.memview)) __PYX_ERR(0, 18, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("group_dense", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 18, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
  ...
  if (unlikely(__pyx_memslice_transpose(&__pyx_t_1) == 0)) __PYX_ERR(0, 19, __pyx_L1_error)
  __pyx_v_B = __pyx_t_1;
  __pyx_t_1.memview = NULL;
  __pyx_t_1.data = NULL;

  /* "scipy/optimize/_group_columns.pyx":21
 *     cdef int [:, :] B = A.T  # Transposed view for convenience.
 * 
 *     cdef int [:] groups = np.full(n, -1, dtype=np.int32)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_full); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 21, __pyx_L1_error)
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_6, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 21, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_v_groups = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "scipy/optimize/_group_columns.pyx":22
 * 
 *     cdef int [:] groups = np.full(n, -1, dtype=np.int32)
 *     cdef int current_group = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/optimize/_group_columns.pyx":26
 *     cdef int i, j, k
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_empty); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_t_6 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_4, __pyx_t_6); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 26, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  ...
  /* "scipy/optimize/_group_columns.pyx":27
 * 
 *     union = np.empty(m, dtype=np.int32)
 *     cdef int [:] union_v = union             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_union, PyBUF_WRITABLE); if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 27, __pyx_L1_error)
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "scipy/optimize/_group_columns.pyx":31
 *     # Loop through all the columns.
 *     for i in range(n):
 *         if groups[i] >= 0:  # A group was already assigned.             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    /* "scipy/optimize/_group_columns.pyx":34
 *             continue
 * 
 *         groups[i] = current_group             # <<<<<<<<<<<<<<
 *         all_grouped = True
 ...
 */
    ...
    *((int *) ( /* dim=0 */ (__pyx_v_groups.data + __pyx_t_13 * __pyx_v_groups.strides[0]) )) = __pyx_v_current_group;
...
if (unlikely(__pyx_memoryview_copy_contents(__pyx_t_7, __pyx_v_union_v, 1, 1, 0) < 0)) __PYX_ERR(0, 37, __pyx_L1_error)
 ...
 */
    ...
    for (__pyx_t_16 = 0; __pyx_t_16 < __pyx_t_15; __pyx_t_16+=1) {
      ...
      /* "scipy/optimize/_group_columns.pyx":40
 * 
 *         for j in range(groups.shape[0]):
 *             if groups[j] < 0:             # <<<<<<<<<<<<<<
 *                 all_grouped = False
 ...
 */
      ...
      __pyx_t_12 = (((*((int *) ( /* dim=0 */ (__pyx_v_groups.data + __pyx_t_17 * __pyx_v_groups.strides[0]) ))) < 0) != 0);
      if (__pyx_t_12) {
 ...
 */
      ...
      /* "scipy/optimize/_group_columns.pyx":43
 *                 all_grouped = False
 *             else:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
        ...
        __pyx_t_22 = (((*((int *) ( /* dim=0 */ (__pyx_v_union_v.data + __pyx_t_21 * __pyx_v_union_v.strides[0]) ))) > 0) != 0);
        if (__pyx_t_22) {
        } else {
        ...
        __pyx_t_22 = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_B.data + __pyx_t_23 * __pyx_v_B.strides[0]) ) + __pyx_t_24 * __pyx_v_B.strides[1]) ))) > 0) != 0);
        __pyx_t_12 = __pyx_t_22;
        __pyx_L12_bool_binop_done:;
        if (__pyx_t_12) {

          /* "scipy/optimize/_group_columns.pyx":49
 *             for k in range(m):
 *                 if union_v[k] > 0 and B[j, k] > 0:
 *                     intersect = True             # <<<<<<<<<<<<<<
 *                     break
 ...
 */
          ...
          /* "scipy/optimize/_group_columns.pyx":50
 *                 if union_v[k] > 0 and B[j, k] > 0:
 *                     intersect = True
 *                     break             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      if (__pyx_t_12) {
        ...
        /* "scipy/optimize/_group_columns.pyx":54
 *             # If not, add it to the union and assign the group to it.
 *             if not intersect:
 *                 union += B[j]             # <<<<<<<<<<<<<<
 *                 groups[j] = current_group
...
__pyx_t_5 = __pyx_memoryview_fromslice(__pyx_t_7, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_5);
        __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
        __pyx_t_7.memview = NULL;
        __pyx_t_7.data = NULL;
        __pyx_t_6 = PyNumber_InPlaceAdd(__pyx_v_union, __pyx_t_5); if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 54, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_6);
        __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
        ...
        *((int *) ( /* dim=0 */ (__pyx_v_groups.data + __pyx_t_25 * __pyx_v_groups.strides[0]) )) = __pyx_v_current_group;
 ...
 */
    ...
    /* "scipy/optimize/_group_columns.pyx":57
 *                 groups[j] = current_group
 * 
 *         if all_grouped:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
  ...
  /* "scipy/optimize/_group_columns.pyx":62
 *         current_group += 1
 * 
 *     return groups.base             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_6 = __pyx_memoryview_fromslice(__pyx_v_groups, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_6)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_6);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_6, __pyx_n_s_base); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 62, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
...
static PyObject *__pyx_pw_5scipy_8optimize_14_group_columns_3group_sparse(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("group_sparse (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_n)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("group_sparse", 1, 4, 4, 1); __PYX_ERR(0, 66, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_indices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("group_sparse", 1, 4, 4, 2); __PYX_ERR(0, 66, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_indptr)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("group_sparse", 1, 4, 4, 3); __PYX_ERR(0, 66, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "group_sparse") < 0)) __PYX_ERR(0, 66, __pyx_L3_error)
      }
    ...
    __pyx_v_m = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_m == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L3_error)
    __pyx_v_n = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_n == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 66, __pyx_L3_error)
    __pyx_v_indices = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_indices.memview)) __PYX_ERR(0, 66, __pyx_L3_error)
    __pyx_v_indptr = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_indptr.memview)) __PYX_ERR(0, 66, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("group_sparse", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 66, __pyx_L3_error)
  __pyx_L3_error:;
...
static PyObject *__pyx_pf_5scipy_8optimize_14_group_columns_2group_sparse(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_m, int __pyx_v_n, __Pyx_memviewslice __pyx_v_indices, __Pyx_memviewslice __pyx_v_indptr) {
  ...
  /* "scipy/optimize/_group_columns.pyx":67
 * @cython.wraparound(False)
 * def group_sparse(int m, int n, int [:] indices, int [:] indptr):
 *     cdef int [:] groups = np.full(n, -1, dtype=np.int32)             # <<<<<<<<<<<<<<
 *     cdef int current_group = 0
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_full); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_int32); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_t_5, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 67, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_groups = __pyx_t_6;
  __pyx_t_6.memview = NULL;
  __pyx_t_6.data = NULL;

  /* "scipy/optimize/_group_columns.pyx":68
 * def group_sparse(int m, int n, int [:] indices, int [:] indptr):
 *     cdef int [:] groups = np.full(n, -1, dtype=np.int32)
 *     cdef int current_group = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "scipy/optimize/_group_columns.pyx":72
 *     cdef int i, j, k
 * 
 *     union = np.empty(m, dtype=np.int32)             # <<<<<<<<<<<<<<
 *     cdef int [:] union_v = union
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_empty); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyInt_From_int(__pyx_v_m); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_int32); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  if (PyDict_SetItem(__pyx_t_5, __pyx_n_s_dtype, __pyx_t_4) < 0) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_3, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 72, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 *     for i in range(n):
 */
  __pyx_t_6 = __Pyx_PyObject_to_MemoryviewSlice_ds_int(__pyx_v_union, PyBUF_WRITABLE); if (unlikely(!__pyx_t_6.memview)) __PYX_ERR(0, 73, __pyx_L1_error)
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "scipy/optimize/_group_columns.pyx":76
 * 
 *     for i in range(n):
 *         if groups[i] >= 0:             # <<<<<<<<<<<<<<
 *             continue
 ...
 */
    ...
    /* "scipy/optimize/_group_columns.pyx":79
 *             continue
 * 
 *         groups[i] = current_group             # <<<<<<<<<<<<<<
 *         all_grouped = True
 ...
 */
    ...
    if (__pyx_t_13 < 0) {
      __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_13 >= __pyx_v_groups.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
 ...
 *             union_v[indices[k]] = 1
 */
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_v_union, __pyx_n_s_fill); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 82, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_3 = NULL;
    ...
    /* "scipy/optimize/_group_columns.pyx":83
 * 
 *         union.fill(0)
 *         for k in range(indptr[i], indptr[i + 1]):             # <<<<<<<<<<<<<<
 *             union_v[indices[k]] = 1
 ...
 */
    ...
    if (__pyx_t_14 < 0) {
      __pyx_t_11 = 0;
    } else if (unlikely(__pyx_t_14 >= __pyx_v_indptr.shape[0])) __pyx_t_11 = 0;
    if (unlikely(__pyx_t_11 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_11);
    ...
    if (__pyx_t_15 < 0) {
      __pyx_t_16 = 0;
    } else if (unlikely(__pyx_t_15 >= __pyx_v_indptr.shape[0])) __pyx_t_16 = 0;
    if (unlikely(__pyx_t_16 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_16);
      __PYX_ERR(0, 83, __pyx_L1_error)
    }
    __pyx_t_16 = __pyx_t_11;
    for (__pyx_t_17 = (*((int *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_15 * __pyx_v_indptr.strides[0]) ))); __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
 ...
 */
      ...
      if (__pyx_t_18 < 0) {
        __pyx_t_19 = 0;
      } else if (unlikely(__pyx_t_18 >= __pyx_v_indices.shape[0])) __pyx_t_19 = 0;
      if (unlikely(__pyx_t_19 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_19);
        __PYX_ERR(0, 84, __pyx_L1_error)
      }
      __pyx_t_20 = (*((int *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_18 * __pyx_v_indices.strides[0]) )));
      __pyx_t_19 = -1;
      if (__pyx_t_20 < 0) {
        __pyx_t_19 = 0;
      } else if (unlikely(__pyx_t_20 >= __pyx_v_union_v.shape[0])) __pyx_t_19 = 0;
      if (unlikely(__pyx_t_19 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_19);
        __PYX_ERR(0, 84, __pyx_L1_error)
      }
      *((int *) ( /* dim=0 */ (__pyx_v_union_v.data + __pyx_t_20 * __pyx_v_union_v.strides[0]) )) = 1;
    }
 ...
 *                 all_grouped = False
 */
    __pyx_t_21 = (__pyx_v_groups.shape[0]);
    __pyx_t_22 = __pyx_t_21;
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_22; __pyx_t_11+=1) {
      __pyx_v_j = __pyx_t_11;

      /* "scipy/optimize/_group_columns.pyx":87
 * 
 *         for j in range(groups.shape[0]):
 *             if groups[j] < 0:             # <<<<<<<<<<<<<<
 *                 all_grouped = False
 ...
 */
      ...
      if (__pyx_t_23 < 0) {
        __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_23 >= __pyx_v_groups.shape[0])) __pyx_t_16 = 0;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 87, __pyx_L1_error)
      }
      __pyx_t_12 = (((*((int *) ( /* dim=0 */ (__pyx_v_groups.data + __pyx_t_23 * __pyx_v_groups.strides[0]) ))) < 0) != 0);
      if (__pyx_t_12) {
 ...
 */
      ...
      if (__pyx_t_24 < 0) {
        __pyx_t_16 = 0;
      } else if (unlikely(__pyx_t_24 >= __pyx_v_indptr.shape[0])) __pyx_t_16 = 0;
      if (unlikely(__pyx_t_16 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_16);
        __PYX_ERR(0, 93, __pyx_L1_error)
      }
      __pyx_t_16 = (*((int *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_24 * __pyx_v_indptr.strides[0]) )));
      __pyx_t_25 = __pyx_v_j;
      __pyx_t_17 = -1;
      if (__pyx_t_25 < 0) {
        __pyx_t_17 = 0;
      } else if (unlikely(__pyx_t_25 >= __pyx_v_indptr.shape[0])) __pyx_t_17 = 0;
      if (unlikely(__pyx_t_17 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_17);
        __PYX_ERR(0, 93, __pyx_L1_error)
      }
      __pyx_t_17 = __pyx_t_16;
      for (__pyx_t_19 = (*((int *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_25 * __pyx_v_indptr.strides[0]) ))); __pyx_t_19 < __pyx_t_17; __pyx_t_19+=1) {
 ...
 */
        ...
        if (__pyx_t_26 < 0) {
          __pyx_t_27 = 0;
        } else if (unlikely(__pyx_t_26 >= __pyx_v_indices.shape[0])) __pyx_t_27 = 0;
        if (unlikely(__pyx_t_27 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_27);
          __PYX_ERR(0, 94, __pyx_L1_error)
        }
        __pyx_t_28 = (*((int *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_26 * __pyx_v_indices.strides[0]) )));
        __pyx_t_27 = -1;
        if (__pyx_t_28 < 0) {
          __pyx_t_27 = 0;
        } else if (unlikely(__pyx_t_28 >= __pyx_v_union_v.shape[0])) __pyx_t_27 = 0;
        if (unlikely(__pyx_t_27 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_27);
          __PYX_ERR(0, 94, __pyx_L1_error)
        }
        __pyx_t_12 = (((*((int *) ( /* dim=0 */ (__pyx_v_union_v.data + __pyx_t_28 * __pyx_v_union_v.strides[0]) ))) == 1) != 0);
        if (__pyx_t_12) {
 ...
 */
        ...
        if (__pyx_t_29 < 0) {
          __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_29 >= __pyx_v_indptr.shape[0])) __pyx_t_16 = 0;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          __PYX_ERR(0, 98, __pyx_L1_error)
        }
        __pyx_t_16 = (*((int *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_29 * __pyx_v_indptr.strides[0]) )));
        __pyx_t_30 = __pyx_v_j;
        __pyx_t_17 = -1;
        if (__pyx_t_30 < 0) {
          __pyx_t_17 = 0;
        } else if (unlikely(__pyx_t_30 >= __pyx_v_indptr.shape[0])) __pyx_t_17 = 0;
        if (unlikely(__pyx_t_17 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_17);
          __PYX_ERR(0, 98, __pyx_L1_error)
        }
        __pyx_t_17 = __pyx_t_16;
        for (__pyx_t_19 = (*((int *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_30 * __pyx_v_indptr.strides[0]) ))); __pyx_t_19 < __pyx_t_17; __pyx_t_19+=1) {
          __pyx_v_k = __pyx_t_19;

          /* "scipy/optimize/_group_columns.pyx":99
 *             if not intersect:
 *                 for k in range(indptr[j], indptr[j + 1]):
 *                     union_v[indices[k]] = 1             # <<<<<<<<<<<<<<
 *                 groups[j] = current_group
 ...
 */
          ...
          if (__pyx_t_31 < 0) {
            __pyx_t_27 = 0;
          } else if (unlikely(__pyx_t_31 >= __pyx_v_indices.shape[0])) __pyx_t_27 = 0;
          if (unlikely(__pyx_t_27 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_27);
            __PYX_ERR(0, 99, __pyx_L1_error)
          }
          __pyx_t_32 = (*((int *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_31 * __pyx_v_indices.strides[0]) )));
          __pyx_t_27 = -1;
          if (__pyx_t_32 < 0) {
            __pyx_t_27 = 0;
          } else if (unlikely(__pyx_t_32 >= __pyx_v_union_v.shape[0])) __pyx_t_27 = 0;
          if (unlikely(__pyx_t_27 != -1)) {
            __Pyx_RaiseBufferIndexError(__pyx_t_27);
            __PYX_ERR(0, 99, __pyx_L1_error)
          }
          *((int *) ( /* dim=0 */ (__pyx_v_union_v.data + __pyx_t_32 * __pyx_v_union_v.strides[0]) )) = 1;
        }
 ...
 */
        ...
        if (__pyx_t_33 < 0) {
          __pyx_t_16 = 0;
        } else if (unlikely(__pyx_t_33 >= __pyx_v_groups.shape[0])) __pyx_t_16 = 0;
        if (unlikely(__pyx_t_16 != -1)) {
          __Pyx_RaiseBufferIndexError(__pyx_t_16);
          __PYX_ERR(0, 100, __pyx_L1_error)
        }
        *((int *) ( /* dim=0 */ (__pyx_v_groups.data + __pyx_t_33 * __pyx_v_groups.strides[0]) )) = __pyx_v_current_group;
 ...
 */
    ...
    /* "scipy/optimize/_group_columns.pyx":102
 *                 groups[j] = current_group
 * 
 *         if all_grouped:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
  ...
  /* "scipy/optimize/_group_columns.pyx":107
 *         current_group += 1
 * 
 *     return groups.base             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_groups, 1, (PyObject *(*)(char *)) __pyx_memview_get_int, (int (*)(char *, PyObject *)) __pyx_memview_set_int, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 107, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_base); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 107, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_r = __pyx_t_5;
  __pyx_t_5 = 0;
 ...
 * 
 */
  __pyx_tuple__26 = PyTuple_Pack(13, __pyx_n_s_m, __pyx_n_s_n, __pyx_n_s_A, __pyx_n_s_B, __pyx_n_s_groups, __pyx_n_s_current_group, __pyx_n_s_i, __pyx_n_s_j, __pyx_n_s_k, __pyx_n_s_union, __pyx_n_s_union_v, __pyx_n_s_all_grouped, __pyx_n_s_intersect); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(3, 0, 13, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_group_columns_pyx, __pyx_n_s_group_dense, 18, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 18, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "scipy/optimize/_group_columns.pyx":10
 * cimport cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_8optimize_14_group_columns_1group_dense, NULL, __pyx_n_s_scipy_optimize__group_columns); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_group_dense, __pyx_t_1) < 0) __PYX_ERR(0, 18, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 *     cdef int current_group = 0
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_5scipy_8optimize_14_group_columns_3group_sparse, NULL, __pyx_n_s_scipy_optimize__group_columns); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_group_sparse, __pyx_t_1) < 0) __PYX_ERR(0, 66, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
