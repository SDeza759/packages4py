...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "sources": [
            "/home/jni/projects/scikit-image/skimage/future/graph/_ncut_cy.pyx"
        ]
    },
 ...
 */
    ...
    for (__pyx_t_15 = (*((__pyx_t_5numpy_int32_t *) ( /* dim=0 */ (__pyx_v_indptr.data + __pyx_t_13 * __pyx_v_indptr.strides[0]) ))); __pyx_t_15 < __pyx_t_14; __pyx_t_15+=1) {
 ...
 */
      ...
      __pyx_v_row = (*((__pyx_t_5numpy_int32_t *) ( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_16 * __pyx_v_indices.strides[0]) )));
 ...
 */
      ...
      __pyx_t_19 = (((*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_cut_mask.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_cut_mask.diminfo[0].strides)) != (*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_uint8_t *, __pyx_pybuffernd_cut_mask.rcbuffer->pybuffer.buf, __pyx_t_18, __pyx_pybuffernd_cut_mask.diminfo[0].strides))) != 0);
      if (__pyx_t_19) {
 ...
 */
        ...
        __pyx_v_cost = (__pyx_v_cost + (*((__pyx_t_5numpy_double_t *) ( /* dim=0 */ (__pyx_v_data.data + __pyx_t_20 * __pyx_v_data.strides[0]) ))));
